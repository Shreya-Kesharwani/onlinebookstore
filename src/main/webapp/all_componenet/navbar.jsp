...
<nav
	class="navbar navbar-expand-lg navbar-dark bg-custom <!-- bg-body-tertiary-->">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<form class="d-flex" role="search">
				...
				<button class="btn btn-light" type="submit"><i class="fas fa-cog"></i> Setting</button>
				<button class="btn btn-light ml-3" type="submit"><i class="fa-solid fa-phone"></i> Contact us</button>
        ...
        <button class="btn btn-light mr-2 custom-setting-button" type="submit"><i class="fas fa-cog"></i> Setting</button>
        <button class="btn btn-light" type="submit"><i class="fa-solid fa-phone"></i> Contact us</button>
    </form>
